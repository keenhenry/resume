...
\begin{resume}
    ...
    \textsl{Software Engineer} \hfill 10/2011 -- Present \vspace{-3mm}\\\vspace{-1mm}%
      ...
      \item Developed tools in Python to support development activities: map clipping, creation and testing automation
      \item Technologies used: C/C++, Boost, Git, Jira, Bitbucket, Python, Bash, SQLite/Spatialite
      \end{list2}
