...
\begin{resume}
    ...
    \textsl{Software Engineer} \hfill 10/2011 -- Present \vspace{-3mm}\\\vspace{-1mm}%
      ...
      \item Mentored new colleauges and shared management role of projects
    ...
    \textbf{Website Performance Optimization} \url{http://bit.ly/1XLxEq4} \hfill 09/2015 \vspace{-3mm}\\\vspace{-1mm}%
      \begin{list2}
       \item Applied website performance improvment techniques to personal wiki site
      \end{list2}
    \vspace{-2mm}
    ...
    \textbf{MapFlow} \hfill 11/2015 \vspace{-3mm}\\\vspace{-1mm}%
      \begin{list2}
       ...
       \item A filesystem crawler built for collecting map metadata
