...
\begin{resume}
    ...
    \textsl{Software Engineer} \hfill 10/2011 -- Present \vspace{-3mm}\\\vspace{-1mm}%
      ...
      % \item Technology used: C/C++, bazaar, SQLite/Spatialite, Boost, Sphinx
      \end{list2}

    % this job experience can be removed
    ...
    %___________________________________________________________________________
    % Massive Open Online Course: this part should be optional
    ...
    \textbf{Personal Wiki} - \url{http://keenhenry-wiki.appspot.com} \hfill 01/2015 \vspace{-3mm}\\\vspace{-1mm}%
      \begin{list2}
       ...
       \item Technology used: Python, jinja2, CSS3, HTML, jQuery, Bootstrap 3, memcache, webapp2%d3.js
      \end{list2}
    ...
    \textbf{eServ} - \url{https://github.com/keenhenry/eserv} \hfill 12/2014 \vspace{-3mm}\\\vspace{-1mm}%
      \begin{list2}
       ...
       \item Technology used: C, pthread, jQuery, AJAX% pthread, libevent?
      \end{list2}
